...
public class pnlTblConsultoriosMasUtilizados extends JPanel {
    ...
    private void initComponents() {
        String[] columnas = { "Consultorio", "Veces Utilizado" };
        ...
        tblConsultorios = new JTable(modelo);
        estiloTabla(tblConsultorios);

        scrollTabla = new JScrollPane(tblConsultorios);
    ...
    public void cargarDatos(ResultSet rs) {
        try {
            ...
            JOptionPane.showMessageDialog(this,
                "Error al cargar consultorios: " + e.getMessage(),
    ...
    public int getFilaSeleccionada() {
        return tblConsultorios.getSelectedRow();
    }
